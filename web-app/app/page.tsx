...
export default function AuthPage() {
  ...
  return (
    ...
    >
      ...
      {/* Container Box */}
      <div className="w-full max-w-xs rounded-2xl p-4 bg-[rgba(30,41,59,0.6)] backdrop-blur-2xl border-t border-l border-white/15 border-b border-r border-white/5 shadow-[0_10px_40px_-10px_rgba(0,60,108,0.4)]">
