...
export default function OnboardingPage() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md rounded-2xl p-6 bg-[rgba(30,41,59,0.6)] backdrop-blur-2xl border-t border-l border-white/15 border-b border-r border-white/5 shadow-[0_10px_40px_-10px_rgba(0,60,108,0.4)] text-center">
        ...
        <p className="text-sm text-[#c2c6d0] mb-6">
          Want to set your daily calorie and macro targets now? This powers the progress rings on your dashboard. You can always change this later.
        </p>
